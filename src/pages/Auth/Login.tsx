  ...
  return (
    <div
      className={`flex max-h-screen items-center justify-center ${
        isMobile ? "gradient-background-mobile" : "gradient-background"
      } p-4 lg:p-0`}
    >
      <div className="flex w-full max-w-sm flex-col rounded-3xl bg-white p-6 shadow-2xl lg:h-screen lg:max-w-none lg:flex-row lg:p-0 lg:shadow-none lg:rounded-none min-h-0">
        <LeftPanel />
